...
namespace WindowsFormsApplication1
{
    ...
    public class Epg
    {
        ...
        /// </summary>
        /// <param name="chan">Channel name</param>
        public int getEpg(string chan, string ChanId)
        {
            ...
            if (selectedPlugin.PluginType == "offline" && selectedPlugin.Name == "xmltv")
                xmltvparser = true;
    ...
    public class EpgDetails
    {
        ...
        /// Constructor
        /// </summary>
        public EpgDetails(string _CachePath)
        {
            selectedPlugin = new SiolPlugin.EpgPlugin();
